<div class="container mt-5">
 	<div class="row">
 		<div class="col-lg-4 p-4 order-lg-1 order-md-2 order-2">
 			<h3 class="h-font fw-bold fs-3 mb-2 ">Lippo Carita</h3>
 			<p>Selamat datang di Lippo Carita, destinasi sempurna untuk menikmati keindahan Pantai Carita, Banten.</p>
 		</div>
...
<h6 class="text-center bg-dark text-white p-3 m-0">&copy; Anggi, 2025</h6>
